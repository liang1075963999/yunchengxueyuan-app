...
//        adapter.notifyDataSetChanged();
    ...
    class adapter extends ArrayAdapter<newsneirong> {
        cheng c;
        int h;
        List<newsneirong>list;
        public adapter(Context context, int resource, List<newsneirong> objects) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
                newsneirong f = getItem(position);
                c = new cheng();
