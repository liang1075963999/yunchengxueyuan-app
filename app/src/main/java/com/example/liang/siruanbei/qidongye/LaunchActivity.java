package com.example.liang.siruanbei.qidongye;


import android.os.Handler;

import com.example.liang.siruanbei.DragTopActivity;
import com.example.liang.siruanbei.base.BaseActivity;
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (!SPUtil.getBoolean(Constant.SP_IS_FIRST_LOGIN, false)) {
                    ...
                    StartActivityUtil.startActivity(LaunchActivity.this, DragTopActivity.class);
                }
                finish();
            }
        }, 2 * 1000);
