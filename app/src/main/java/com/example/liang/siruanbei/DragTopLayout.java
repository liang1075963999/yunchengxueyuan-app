...
public class DragTopLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        // init from attrs
        TypedArray a = getContext().obtainStyledAttributes(attrs, github.chenupt.dragtoplayout.R.styleable.DragTopLayout);
        setCollapseOffset(a.getDimensionPixelSize(github.chenupt.dragtoplayout.R.styleable.DragTopLayout_dtlCollapseOffset, collapseOffset));
        overDrag = a.getBoolean(github.chenupt.dragtoplayout.R.styleable.DragTopLayout_dtlOverDrag, overDrag);
        dragContentViewId = a.getResourceId(github.chenupt.dragtoplayout.R.styleable.DragTopLayout_dtlDragContentView, -1);
        topViewId = a.getResourceId(github.chenupt.dragtoplayout.R.styleable.DragTopLayout_dtlTopView, -1);
        initOpen(a.getBoolean(github.chenupt.dragtoplayout.R.styleable.DragTopLayout_dtlOpen, true));
        captureTop = a.getBoolean(github.chenupt.dragtoplayout.R.styleable.DragTopLayout_dtlCaptureTop, true);
        a.recycle();
    }
