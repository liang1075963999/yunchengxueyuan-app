package com.example.liang.siruanbei.kebiao;
...
public class CourseDao {
    ...
    public static List<CourseModel>[] getCourseData() {
        ...
        models_1.add(new CourseModel(1, "Ruby", 3, 2, 1, "A453", (int) (Math.random() * 10)));
        models_1.add(new CourseModel(1, "PHP", 6, 2, 1, "A483", (int) (Math.random() * 10)));
        ...
        models_4.add(new CourseModel(4, "C#", 1, 2, 4, "A666", (int) (Math.random() * 10)));
        ...
        models_6.add(new CourseModel(10, "SQL", 5, 2, 6, "A402", (int) (Math.random() * 10)));
